...
function changeDirection(event) {
    ...
    if (keyPressed === esquerda && !indoParaDireita) { // Atividade 3): Verificar se está indo para esquerda
        xVelocity = -unitSize;
        yVelocity = 0;
    } else if (keyPressed === cima && !descendo) { // Atividade 4): verificar se está indo para cima
        xVelocity = 0;
        yVelocity = -unitSize;
    } else if (keyPressed === direita && !indoParaEsquerda) { // Atividade 5): verificar se está indo para a direita
        xVelocity = unitSize;
        yVelocity = 0;
    } else if (keyPressed === baixo && !subindo) { // Atividade 6): verificar se está indo para baixo
        xVelocity = 0;
        yVelocity = unitSize;
    }
}
